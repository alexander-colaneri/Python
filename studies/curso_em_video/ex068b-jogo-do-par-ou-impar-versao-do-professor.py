...
while True:
    ...
    tipo = ' '
    while tipo not in 'PI':  # Aqui, o professor preferiu que sejam
        # encontradas as letras "P" ou "I" na primeira posição da opção
        # escolhida pelo jogador, para indicar a escolha por par ou ímpar.
